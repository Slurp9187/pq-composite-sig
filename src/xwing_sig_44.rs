...
use libcrux_ml_dsa::ml_dsa_44::{
    MLDSA44KeyPair, MLDSA44Signature, MLDSA44VerificationKey, generate_key_pair,
...
const ML_PK_SIZE: usize = 1312; // Approximate size for ML-DSA-44 public key
const ED_PK_SIZE: usize = 32;
const BINDING_TAG_SIZE: usize = 32;

const ML_SIG_SIZE: usize = 2420; // Approximate size for ML-DSA-44 signature
